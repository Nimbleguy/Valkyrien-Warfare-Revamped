...
public class EntityHarpoon extends EntityArrow{
	...
	public void onHit(RayTraceResult raytrace){
		...
		if(entity == null){//its a block
			...
			if(ValkyrienWarfareHooks.isBlockPartOfShip(this.worldObj, raytrace.getBlockPos())){
				this.startRiding(ValkyrienWarfareHooks.getShipEntityManagingPos(this.worldObj, raytrace.getBlockPos()));
			}
		}
